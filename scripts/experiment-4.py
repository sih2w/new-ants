...
if __name__ == "__main__":
    file_names = [f"Experiment_4_{index}" for index in range(5)]
    ...
    for index, file_name in enumerate(file_names):
        ...
        if len(episodes) == 0:
            ...
            EventFunctions.Connect(env["Env"]["StepStarted"], lambda *args, **kwargs: Experiment4Functions.OnTrainingStepStarted(env, *args, **kwargs))
        ...
        EventFunctions.Connect(env["Env"]["StepStarted"], lambda *args, **kwargs: Experiment4Functions.OnTestingStepStarted(env, *args, **kwargs))
